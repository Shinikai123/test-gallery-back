...
import { multerFile } from "../utils/multerFile";
...
router.post('/users/avatar/:userId', multerFile.single('file'), userController.uploadAvatar);
router.get('/users/avatar/:userId', userController.getAvatar);



router.post('/upload/:id', multerFile.single('file'), videoController.uploadVideo);
